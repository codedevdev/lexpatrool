...
function hasSanctionSignals(heading: string, body: string): boolean {
  ...
  // Не путать с УК: в процессуалке часто «…назначено наказание в виде лишения…» без таблицы мер
  if (
  ...
  if (
    ...
    // Справочный перечень оснований: «…лишения свободы или штрафная санкция…» без конкретных сроков/сумм
